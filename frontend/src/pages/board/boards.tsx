		...
		<>
			<div className='mx-auto w-full'>
				...
				{!isLoading && !data?.length && (
					<div className='col-span-full mt-6 flex flex-col items-center justify-center rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50/50 p-12 text-center'>
				...
				{isLoading ? (
					...
					<div className='mt-6 grid grid-cols-[repeat(auto-fill,minmax(380px,1fr))] items-center justify-center gap-4'>
						{data &&
							data?.map((board) => (
								<BoardCard
									key={board?.id}
