...
container.bind<AuthService>(TTYPES.AuthService).to(AuthService).inSingletonScope()
container.bind<UserService>(TTYPES.UserService).to(UserService).inSingletonScope()
